...
import { MdOutlineDashboard, MdOutlineAccountTree, MdOutlineMonitor, MdHome} from 'react-icons/md';
...
const MainLayout = ({ children, activeMenu, setActiveMenu, hasData }) => {
    ...
    const menuItems = [
        ...
        { id: 'start', label: 'Inicio', icon: <MdHome {...iconProps} />, requiresData: true },
